...
Santacoin is released under the terms of the MIT license. See `COPYING` for more
...
If it is a simple/trivial/non-controversial change, then one of the Santacoin
